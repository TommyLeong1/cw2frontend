...
const EditFavCat = () => {
    ...
    const GetCatPostData = () => {
        //get all favourite catpost data
    ...
    const handleEdit = () =>{
        const url = `https://cw2backend.tommyleong1.repl.co/favcatposts/${id}`
        const Credentials = { id, title, fullText, description, comments, likes, imgURL, summary, breed }
    ...
    return (
        <div>
            ...
            <div className='model-box-view'>
                ...
                >
                    <Modal.Header closeButton>
                        <Modal.Title>Add Favourite Cat Post</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <div>
                            <div className='form-group'>
                          ...
                          <div className='form-group mt-3'>
                            ...
                            <Button type='submit' className='btn btn-success mt-4' onClick={handleSubmite}>Add Favourite Cat Post</Button>
                        </div>
                    </Modal.Body>
                    <Modal.Footer>
                    ...
                    <Modal.Body>
                        <div>
                          ...
                          <div className='form-group mt-3'>
                            ...
                            <Button type='submit' className='btn btn-warning mt-4' onClick={handleEdit}>Edit Favourite Cat Post</Button>
                        </div>
                    </Modal.Body>
                    <Modal.Footer>
          ...
          {/* Modal for Edit catpost photo */}
            <div className='model-box-view4'>
                ...
                >
                    <Modal.Header closeButton>
                        <Modal.Title>Edit Favourite Cat Post Photo</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <div>
                            <div className='form-group'>
                            ...
                            <Button type='submit' className='btn btn-warning mt-4' onClick={handlePhotoEdit}>Edit Favourite Cat Post Photo</Button>
                        </div>
                    </Modal.Body>
                    <Modal.Footer>
